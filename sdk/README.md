...
* [transact](docs/sdks/banking/README.md#transact)
* [listTransactions](docs/sdks/banking/README.md#listtransactions)
...
async function run() {
    ...
    const result = await sdk.banking.listTransactions(id, cursor);
...
```typescript
import { SDK } from "@speakeasy-sdks/super-sdk";
import { HTTPClient } from "@speakeasy-sdks/super-sdk/lib/http";
